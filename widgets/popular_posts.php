...
class yogastudio_widget_popular_posts extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => esc_html__('The most popular and most commented blog posts (extended)', 'yogastudio'));
		parent::__construct( 'yogastudio_widget_popular_posts', esc_html__('YogaStudio - Most Popular & Commented Posts', 'yogastudio'), $widget_ops );
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_popular')); ?>"><?php esc_html_e('Most popular tab title:', 'yogastudio'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_commented')); ?>"><?php esc_html_e('Most commented tab title:', 'yogastudio'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_liked')); ?>"><?php esc_html_e('Most liked tab title:', 'yogastudio'); ?></label>
	...
	function yogastudio_sc_widget_popular_posts($atts, $content=null){	
		...
		if ( is_object( $wp_widget_factory ) && isset( $wp_widget_factory->widgets, $wp_widget_factory->widgets[ $type ] ) ) {
			$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '')
						...
						. '">';
			ob_start();
			the_widget( $type, $atts, yogastudio_prepare_widgets_args($YOGASTUDIO_GLOBALS['widgets_args'], $id ? $id.'_widget' : 'widget_popular_posts', 'widget_popular_posts') );
...
if (!function_exists('yogastudio_widget_popular_posts_reg_shortcodes_vc')) {
	...
	function yogastudio_widget_popular_posts_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"name" => esc_html__("Widget Popular Posts", "yogastudio"),
				"description" => wp_kses( __("Insert popular posts list with thumbs and post's meta", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
				...
				"params" => array(
					...
					array(
						...
						"heading" => esc_html__("Most popular tab title", "yogastudio"),
						"description" => wp_kses( __("Most popular tab title", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"heading" => esc_html__("Most commented tab title", "yogastudio"),
						"description" => wp_kses( __("Most commented tab title", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"heading" => esc_html__("Most liked tab title", "yogastudio"),
						"description" => wp_kses( __("Most liked tab title", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
