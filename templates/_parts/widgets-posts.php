...
if ($show_counters) {
	if (yogastudio_strpos($show_counters, 'views')!==false) {
		$post_counters = yogastudio_get_post_views($post_id);
		...
		$post_counters = yogastudio_get_post_likes($post_id);
		...
		$post_counters = yogastudio_reviews_marks_to_display(get_post_meta($post_id, $post_rating, true));
