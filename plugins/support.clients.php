<?php
/**
 * YogaStudio Framework: Clients post type settings
 *
 * @package	yogastudio
...
if (!function_exists('yogastudio_clients_after_theme_setup')) {
	...
	function yogastudio_clients_after_theme_setup() {
		...
		if (isset($YOGASTUDIO_GLOBALS['post_meta_box']) && $YOGASTUDIO_GLOBALS['post_meta_box']['page']=='clients') {
			// Meta box fields
			$YOGASTUDIO_GLOBALS['post_meta_box']['title'] = esc_html__('Client Options', 'yogastudio');
			$YOGASTUDIO_GLOBALS['post_meta_box']['fields'] = array(
				...
				"mb_info_clients_1" => array(
					...
					"override" => "page,post",
					"divider" => false,
					"desc" => wp_kses( __('In this section you can put details for this client', 'yogastudio'), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
					"class" => "client_meta",
					"type" => "info"),
				"client_name" => array(
					"title" => esc_html__('Contact name',  'yogastudio'),
					"desc" => wp_kses( __("Name of the contacts manager", 'yogastudio'), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
					"override" => "page,post",
					"class" => "client_name",
					"std" => '',
					"type" => "text"),
				"client_position" => array(
					...
					"desc" => wp_kses( __("Position of the contacts manager", 'yogastudio'), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
					"override" => "page,post",
				...
				"client_show_link" => array(
					...
					"desc" => wp_kses( __("Show link to client page", 'yogastudio'), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
					"override" => "page,post",
				...
				"client_link" => array(
					...
					"desc" => wp_kses( __("URL of the client's site. If empty - use link to this page", 'yogastudio'), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
					"override" => "page,post",
					"class" => "client_link",
					"std" => '',
					"type" => "text")
...
if ( !function_exists( 'yogastudio_is_clients_page' ) ) {
	function yogastudio_is_clients_page() {
		global $YOGASTUDIO_GLOBALS;
		$is = in_array($YOGASTUDIO_GLOBALS['page_template'], array('blog-clients', 'single-client'));
		if (!$is) {
			if (!empty($YOGASTUDIO_GLOBALS['pre_query']))
				$is = $YOGASTUDIO_GLOBALS['pre_query']->get('post_type')=='clients'
						|| $YOGASTUDIO_GLOBALS['pre_query']->is_tax('clients_group') 
...
if ( !function_exists( 'yogastudio_sc_clients' ) ) {
	function yogastudio_sc_clients($atts, $content=null){	
		...
		global $YOGASTUDIO_GLOBALS;
		$YOGASTUDIO_GLOBALS['sc_clients_id'] = $id;
		$YOGASTUDIO_GLOBALS['sc_clients_style'] = $style;
		$YOGASTUDIO_GLOBALS['sc_clients_counter'] = 0;
		$YOGASTUDIO_GLOBALS['sc_clients_columns'] = $columns;
		$YOGASTUDIO_GLOBALS['sc_clients_slider'] = $slider;
		$YOGASTUDIO_GLOBALS['sc_clients_css_wh'] = $ws . $hs;
		...
		if (yogastudio_param_is_on($custom) && $content) {
			...
			while ( $query->have_posts() ) { 
				...
				$post_meta = get_post_meta($post_data['post_id'], 'yogastudio_post_options', true);
...
if ( !function_exists( 'yogastudio_sc_clients_item' ) ) {
	function yogastudio_sc_clients_item($atts, $content=null) {
		...
		global $YOGASTUDIO_GLOBALS;
		$YOGASTUDIO_GLOBALS['sc_clients_counter']++;
	
		$id = $id ? $id : ($YOGASTUDIO_GLOBALS['sc_clients_id'] ? $YOGASTUDIO_GLOBALS['sc_clients_id'] . '_' . $YOGASTUDIO_GLOBALS['sc_clients_counter'] : '');
	
		$descr = trim(chop(do_shortcode($content)));
	
		$thumb_sizes = yogastudio_get_thumb_sizes(array('layout' => $YOGASTUDIO_GLOBALS['sc_clients_style']));
		...
		$args = array(
			'layout' => $YOGASTUDIO_GLOBALS['sc_clients_style'],
			'number' => $YOGASTUDIO_GLOBALS['sc_clients_counter'],
			'columns_count' => $YOGASTUDIO_GLOBALS['sc_clients_columns'],
			'slider' => $YOGASTUDIO_GLOBALS['sc_clients_slider'],
			'show' => false,
			'descr'  => 0,
			'tag_id' => $id,
			'tag_class' => $class,
			...
			'tag_css' => $css,
			'tag_css_wh' => $YOGASTUDIO_GLOBALS['sc_clients_css_wh'],
...
if (!function_exists('yogastudio_clients_reg_shortcodes')) {
	//add_filter('yogastudio_action_shortcodes_list',	'yogastudio_clients_reg_shortcodes');
	function yogastudio_clients_reg_shortcodes() {
		...
		if (isset($YOGASTUDIO_GLOBALS['shortcodes'])) {
			...
			yogastudio_array_insert_after($YOGASTUDIO_GLOBALS['shortcodes'], 'trx_chat', array(

				// Clients
				"trx_clients" => array(
					"title" => esc_html__("Clients", "yogastudio"),
					"desc" => wp_kses( __("Insert clients list in your page (post)", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
					"decorate" => true,
					"container" => false,
					"params" => array(
						"title" => array(
						...
						"style" => array(
							...
							"desc" => wp_kses( __("Select style to display clients list", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
							"value" => "clients-1",
							"type" => "select",
						...
						"columns" => array(
							...
							"desc" => wp_kses( __("How many columns use to show clients", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
							"value" => 4,
							"min" => 2,
							"max" => 6,
							"step" => 1,
						...
						"slider" => array(
							...
							"desc" => wp_kses( __("Use slider to show clients", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
							"value" => "no",
							"type" => "switch",
					...
					"children" => array(
						...
						"desc" => wp_kses( __("Single client (custom parameters)", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"container" => true,
						"params" => array(
							"name" => array(
								"title" => esc_html__("Name", "yogastudio"),
								"desc" => wp_kses( __("Client's name", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
								"divider" => true,
								"value" => "",
								"type" => "text"
							),
							"position" => array(
								"title" => esc_html__("Position", "yogastudio"),
								"desc" => wp_kses( __("Client's position", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
								"value" => "",
								"type" => "text"
							),
							"link" => array(
								"title" => esc_html__("Link", "yogastudio"),
								"desc" => wp_kses( __("Link on client's personal page", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
								"divider" => true,
								"value" => "",
								"type" => "text"
							),
							"image" => array(
								...
								"desc" => wp_kses( __("Client's image", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
								"value" => "",
								"readonly" => false,
								"type" => "media"
							),
							"_content_" => array(
								"title" => esc_html__("Description", "yogastudio"),
								"desc" => wp_kses( __("Client's short description", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
								"divider" => true,
								"rows" => 4,
								"value" => "",
								"type" => "textarea"
...
if (!function_exists('yogastudio_clients_reg_shortcodes_vc')) {
	//add_filter('yogastudio_action_shortcodes_list_vc',	'yogastudio_clients_reg_shortcodes_vc');
	function yogastudio_clients_reg_shortcodes_vc() {
		...
		vc_map( array(
				...
				"description" => wp_kses( __("Insert clients list", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
				...
				"params" => array(
					array(
						...
						"description" => wp_kses( __("Select style to display clients list", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"class" => "",
						"admin_label" => true,
					...
					array(
						...
						"description" => wp_kses( __("Allow get clients from inner shortcodes (custom) or get it from specified group (cat)", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"class" => "",
					...
					array(
						...
						"description" => wp_kses( __("Select category to show clients. If empty - select clients from any category (group) or from IDs list", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
					...
					array(
						...
						"description" => wp_kses( __("How many columns use to show clients", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"group" => esc_html__('Query', 'yogastudio'),
						"admin_label" => true,
						"class" => "",
						"value" => "4",
					...
					array(
						...
						"description" => wp_kses( __("Comma separated list of client's ID. If set - parameters above (category, count, order, etc.)  are ignored!", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"group" => esc_html__('Query', 'yogastudio'),
						'dependency' => array(
							'element' => 'custom',
							'is_empty' => true
		...
		vc_map( array(
				...
				"description" => wp_kses( __("Client - all data pull out from it account on your site", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
				"show_settings_on_create" => true,
				...
				"params" => array(
					array(
						...
						"description" => wp_kses( __("Client's name", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses( __("Client's position", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						...
						"description" => wp_kses( __("Link on client's personal page", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"description" => wp_kses( __("Clients's image", "yogastudio"), $YOGASTUDIO_GLOBALS['allowed_tags'] ),
						"class" => "",
						"value" => "",
						"type" => "attach_image"
					),
