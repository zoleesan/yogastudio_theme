...
function yogastudio_get_global(var_name) {
	return yogastudio_isset(YOGASTUDIO_GLOBALS[var_name]) ? YOGASTUDIO_GLOBALS[var_name] : '';
}
...
function yogastudio_inc_global(var_name) {
...
function yogastudio_get_global_array(var_name, key) {
	return yogastudio_isset(YOGASTUDIO_GLOBALS[var_name][key]) ? YOGASTUDIO_GLOBALS[var_name][key] : '';
}

// Set global array element
function yogastudio_set_global_array(var_name, key, value) {
	if (!yogastudio_isset(YOGASTUDIO_GLOBALS[var_name])) YOGASTUDIO_GLOBALS[var_name] = {};
	YOGASTUDIO_GLOBALS[var_name][key] = value;
}

// Inc/Dec global array element with specified value
function yogastudio_inc_global_array(var_name, key) {
...
function yogastudio_add_hidden_elements_handler(key, handler) {
	yogastudio_set_global_array('init_hidden_elements', key, handler);
}

// Init hidden elements after tab, accordion, toggles activate
function yogastudio_init_hidden_elements(cont) {
	if (YOGASTUDIO_GLOBALS['init_hidden_elements']) {
		for (key in YOGASTUDIO_GLOBALS['init_hidden_elements']) {
			YOGASTUDIO_GLOBALS['init_hidden_elements'][key](cont);
		}
	}
}
