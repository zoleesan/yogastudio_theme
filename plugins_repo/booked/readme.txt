...
= 1.9.10 =
* *MISC:* Removed extra "Appointments" menu from admin sidebar.
* *MISC:* Removed Add-Ons page, add-ons are now included with new purchases.

= 1.9.9 =
* *FIX:* Fixed a rare issue where options were not able to be added to a custom dropdown field.
* *FIX:* Fixed an issue where Booked would disable the errors coming from front-end WooCommerce forms.
