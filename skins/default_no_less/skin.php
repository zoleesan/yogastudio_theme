...
if ( !function_exists( 'yogastudio_options_settings_theme_setup' ) ) {
	add_action( 'yogastudio_action_before_init_theme', 'yogastudio_options_settings_theme_setup3', 3 );	// Priority 1 for add yogastudio_filter handlers, 2 for create Theme Options
	function yogastudio_options_settings_theme_setup3() {
		global $YOGASTUDIO_GLOBALS;
		$YOGASTUDIO_GLOBALS['options']['top_panel_scheme']['options']		= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
		$YOGASTUDIO_GLOBALS['options']['sidebar_main_scheme']['options']	= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
		$YOGASTUDIO_GLOBALS['options']['sidebar_outer_scheme']['options']	= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
		$YOGASTUDIO_GLOBALS['options']['sidebar_footer_scheme']['options']= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
		$YOGASTUDIO_GLOBALS['options']['testimonials_scheme']['options']	= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
		$YOGASTUDIO_GLOBALS['options']['twitter_scheme']['options']		= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
		$YOGASTUDIO_GLOBALS['options']['contacts_scheme']['options']		= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
		$YOGASTUDIO_GLOBALS['options']['copyright_scheme']['options']		= $YOGASTUDIO_GLOBALS['options_params']['list_bg_tints'];
	}
}
